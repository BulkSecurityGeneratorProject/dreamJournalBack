...
public interface DreamRepository extends JpaRepository<Dream, Long> {
    ...
    @Query("select new map(dream.id, new pl.teneusz.dream.journal.domain.DreamHelper(dream.id,count(elements( dream.comments)))) from Dream dream where dream.id in (:ids)")
