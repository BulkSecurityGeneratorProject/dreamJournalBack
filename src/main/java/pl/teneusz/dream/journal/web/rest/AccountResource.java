...
import pl.teneusz.dream.journal.service.MailService;
import pl.teneusz.dream.journal.service.UserService;
import pl.teneusz.dream.journal.service.dto.UserDTO;
import pl.teneusz.dream.journal.web.rest.vm.KeyAndPasswordVM;
import pl.teneusz.dream.journal.web.rest.vm.ManagedUserVM;
                ...
                .orElseGet(() -> {
                    User user = userService
                        .createUser(managedUserVM.getLogin(), managedUserVM.getPassword(),
                            ...
                            managedUserVM.getLangKey(), managedUserVM.isActivated());
