...
public class CommentResourceIntTest {
    ...
    private static final Boolean DEFAULT_IS_REPLY = false;
    private static final Boolean UPDATED_IS_REPLY = true;
    ...
    public void createComment() throws Exception {
        ...
        assertThat(testComment.isIsReply()).isEqualTo(DEFAULT_IS_REPLY);
    ...
    public void getAllComments() throws Exception {
        ...
        restCommentMockMvc.perform(get("/api/comments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].isReply").value(hasItem(DEFAULT_IS_REPLY.booleanValue())));
    }
    ...
    public void getComment() throws Exception {
        ...
        restCommentMockMvc.perform(get("/api/comments/{id}", comment.getId()))
            ...
            .andExpect(jsonPath("$.isReply").value(DEFAULT_IS_REPLY.booleanValue()));
    }
    ...
    public void updateComment() throws Exception {
        ...
        assertThat(testComment.isIsReply()).isEqualTo(UPDATED_IS_REPLY);
